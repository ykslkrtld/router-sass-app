const About = () => {
  return (
    <main classNam="about">
      ...
      <div classNam="about__container">
        <div classNam="about__job">
          <h2 classNam="text-secondary">2020 - 2021</h2>
          <h3>CLARUSWAY</h3>
        ...
        <div classNam="about__job">
          <h2 classNam="text-secondary">2019 - 2020</h2>
          <h3>Google</h3>
        ...
        <div classNam="about__job">
          <h2 classNam="text-secondary">2017 - 2019</h2>
